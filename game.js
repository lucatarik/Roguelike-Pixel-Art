// game.js - Roguelike con DawnLike tileset, crafting e drop
// Richiede: Phaser 3, EasyStar, localForage, SimplexNoise
...
// Pathfinding BFS sincrono (sostituisce EasyStar asincrono)
...
class BootScene extends Phaser.Scene {
    ...
    preload() {
        const dawnlikePath = 'DawnLike/';

        // Personaggi
        this.load.spritesheet('player', dawnlikePath + 'Characters/Player/player0.png', { frameWidth: 16, frameHeight: 16 });
        this.load.spritesheet('enemy_goblin', dawnlikePath + 'Characters/Goblin/goblin0.png', { frameWidth: 16, frameHeight: 16 });
        this.load.spritesheet('enemy_ogre', dawnlikePath + 'Characters/Ogre/ogre0.png', { frameWidth: 16, frameHeight: 16 });
        this.load.spritesheet('boss', dawnlikePath + 'Characters/Dragon/dragon0.png', { frameWidth: 16, frameHeight: 16 });

        // Oggetti
        this.load.image('potion', dawnlikePath + 'Items/Potions/potion0.png');
        this.load.image('weapon', dawnlikePath + 'Items/Weapons/sword0.png');
        this.load.image('armor', dawnlikePath + 'Items/Armors/chest0.png');
        this.load.image('bone', dawnlikePath + 'Items/Materials/bone0.png');
        this.load.image('leather', dawnlikePath + 'Items/Materials/leather0.png');
        this.load.image('cloth', dawnlikePath + 'Items/Materials/cloth0.png');
        this.load.image('iron_ore', dawnlikePath + 'Items/Materials/iron_ore0.png');

        // Terreno dungeon
        this.load.image('floor', dawnlikePath + 'Dungeon/Floor/floor_brick0.png');
        this.load.image('wall', dawnlikePath + 'Dungeon/Wall/wall_stone0.png');
        this.load.image('stairs', dawnlikePath + 'Dungeon/Stairs/stairs_down0.png');
        this.load.image('fog', dawnlikePath + 'Dungeon/Effects/fog0.png'); // placeholder

        // Overworld
        this.load.image('grass', dawnlikePath + 'Nature/Grass/grass0.png');
        this.load.image('forest', dawnlikePath + 'Nature/Trees/tree0.png');
        this.load.image('mountain', dawnlikePath + 'Nature/Mountain/mountain0.png');
        this.load.image('water', dawnlikePath + 'Nature/Water/water0.png');
        this.load.image('dungeon_entrance', dawnlikePath + 'Dungeon/Structure/entrance0.png');
    }
    create() {
        this.anims.create({
            key: 'player_idle',
        ...
        this.anims.create({
            key: 'goblin_idle',
            frames: this.anims.generateFrameNumbers('enemy_goblin', { start: 0, end: 1 }),
            frameRate: 2,
            repeat: -1
        });
        this.anims.create({
            key: 'ogre_idle',
            frames: this.anims.generateFrameNumbers('enemy_ogre', { start: 0, end: 1 }),
            frameRate: 2,
            repeat: -1
        });
        this.anims.create({
